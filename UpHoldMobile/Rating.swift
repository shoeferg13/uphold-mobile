...
//  UpHoldMobile
//
//  Created by Shannon Ferguson on 7/19/19.
...
@objc public protocol RatingDelegate {
    ...
    @objc optional func floatRatingView(_ ratingView: Rating, didUpdate rating: Double)
    
    /// Returns the rating value as the user pans
    @objc optional func floatRatingView(_ ratingView: Rating, isUpdating rating: Double)
}

/// A simple rating view that can set whole, half or floating point ratings.
@IBDesignable
@objcMembers
open class Rating: UIView {
